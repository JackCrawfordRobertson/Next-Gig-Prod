...
export default function CompleteProfile() {
  ...
  const isFormValid = () => {
    return (
      ...
      profilePicture && profilePicture !== "/av.jpeg"
    );
  };
  ...
  const handleSignUp = async () => {
    ...
    // ✅ In dev mode, skip real sign-up and just log everything.
    if (isDev) {
    ...
    // ✅ Production: Do the real sign-up logic
    try {
      ...
      // 3) Immediately sign them in via NextAuth
      ...
      // 4) If sign-in succeeds, go to subscription page
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            <Avatar className="w-24 h-24 border border-gray-300 shadow-md">
              ...
              <AvatarFallback>
                <img src="/av.jpeg" alt="Default Avatar" className="w-full h-full object-cover" />
              </AvatarFallback>
            </Avatar>
          ...
          {/* Job Titles */}
          <div>
            <Label className="mb-1 block">Job Titles You Want to Search</Label>
            <Input
          ...
          {/* Job Locations */}
          <div>
            <Label className="mb-1 block">Locations You Want to Search</Label>
            <Input
