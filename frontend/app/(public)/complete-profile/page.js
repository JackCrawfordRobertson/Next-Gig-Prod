...
export default function CompleteProfile() {
    ...
    const handleSignUp = async () => {
      ...
      try {
          ...
          const fingerprintQuery = query(usersRef, where("deviceFingerprint", "==", deviceFingerprint));
                ...
                <CardContent className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            {jobTitles.map((title) => (
                                <div key={title} className="flex items-center space-x-2 bg-gray-200 px-2 py-1 rounded">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            {jobLocations.map((loc) => (
                                <div key={loc} className="flex items-center space-x-2 bg-gray-200 px-2 py-1 rounded">
