                        ...
                        <div className="absolute inset-0 p-4">
                            <ChartContainer config={chartConfig} className="h-full">
                                <ResponsiveContainer width="100%" height="100%" aspect={undefined}>
                                    <BarChart data={jobStats} margin={{top: 20, right: 30, left: 20, bottom: 20}}>
                ...
                <TabsContent value="stats" className="h-[calc(100vh-120px)] m-0">
                    <Card className="h-full flex flex-col border-0 shadow-none">
                        <CardHeader className="py-2 px-3 flex flex-row justify-between items-center">
                            <div>
                                <CardTitle className="text-lg">Job Listings Per Day</CardTitle>
        ...
        >
            <CardContent className="p-3">
                <div className="flex justify-between items-start mb-2">
                    ...
                    <Badge variant="outline" className="text-xs py-0 h-5">LinkedIn</Badge>
                </div>
