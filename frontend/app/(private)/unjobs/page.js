        ...
        <TabsContent value="stats" className="h-[calc(100vh-120px)] m-0">
          <Card className="h-full flex flex-col border-0 shadow-none">
            <CardHeader className="py-2 px-3 flex flex-row justify-between items-center">
              <div>
                <CardTitle className="text-lg">UN Job Listings Per Day</CardTitle>
      ...
      <AlertDialog open={showApplyDialog} onOpenChange={(open) => {
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {selectedJob?.title} at {selectedJob?.company || "United Nations"}
            </AlertDialogDescription>
          </AlertDialogHeader>
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 mb-3">
                      <div className="flex items-center text-sm text-muted-foreground">
                        <Building className="h-4 w-4 mr-1" /> {job.company || "United Nations"}
                      </div>
                      <div className="flex items-center text-sm text-muted-foreground">
    ...
    >
      <CardContent className="p-3">
        <div className="flex justify-between items-start mb-2">
          ...
          <Badge variant="outline" className="text-xs py-0 h-5">UN Jobs</Badge>
        </div>
